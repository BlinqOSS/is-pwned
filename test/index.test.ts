...
describe('hashPassword', () => {
  test('should correctly sha-1 a string', () => {
    ...
    expect(pw.hashPassword('apple pear orange grapefruit'))
      .toEqual('FB0CE8FF9619A8D2B20B0352D8AF77969B8CB25B')
  })
})
...
describe('check', () => {
  ...
  test('should correctly identify matching breached passwords', () => {
    const pw = new IsPwned()
    global.fetch.mockResponseOnce(`1D2DA4053E34E76F6576ED1DA63134B5E2A:2
